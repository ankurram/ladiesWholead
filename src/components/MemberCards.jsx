    ...
    <div className='max-w-[70%] w-full mb-5'>
        {
            MemberData.map((cardData, index)=>(
                <div className='border-[1px] border-[#1689a3] mb-5' key={index}>
                    <div className='p-5 h-[90px] flex relative memberCards'>
                        <div className='max-w-[60%] flex items-center w-full border-r-2 border-[#1689a3] mr-5'>{cardData.member}</div>
                        <div className='max-w-[25%] flex items-center w-full border-r-2 border-[#1689a3] mr-5 text-[#1689a3]'>
                            INR {cardData.price}
                        </div>
